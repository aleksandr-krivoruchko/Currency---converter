const data =
  '{ "distance": { "unit": "km", "value": "qq"}, "convert_to": "ft" }';
const rules =
  '{"imperialUnits": { "in": 25.4, "ft": 304.8, "yd": 914.4 },"metriclUnits": { "mm": 1, "cm": 10, "m": 1000, "km": 1000000}}';
...
function converter(data, rules) {
  ...
  const isImperialUnit = Object.keys(imperialUnits).includes(unit);

  const multiplier = isImperialUnit
